module.exports=[957250,a=>{"use strict";var b={get url(){return a.F("packages/next/dist/esm/generated/env.js")},env:{DEV:!1,PROD:!0,MODE:"production",BASE_URL:"/",SSR:!0}};a.s(["envVars",0,{get HEXCLAVE_PORT_PREFIX(){return("u">typeof process?process.env.HEXCLAVE_PORT_PREFIX:void 0)||b.env?.HEXCLAVE_PORT_PREFIX||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX||("u">typeof process?process.env.VITE_HEXCLAVE_PORT_PREFIX:void 0)||b.env?.VITE_HEXCLAVE_PORT_PREFIX||("u">typeof process?process.env.STACK_PORT_PREFIX:void 0)||b.env?.STACK_PORT_PREFIX||("u">typeof process?process.env.NEXT_PUBLIC_STACK_PORT_PREFIX:void 0)||b.env?.NEXT_PUBLIC_STACK_PORT_PREFIX||("u">typeof process?process.env.VITE_STACK_PORT_PREFIX:void 0)||b.env?.VITE_STACK_PORT_PREFIX||void 0},get HEXCLAVE_PROJECT_ID(){return("u">typeof process?process.env.HEXCLAVE_PROJECT_ID:void 0)||b.env?.HEXCLAVE_PROJECT_ID||("u">typeof process?"internal":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_PROJECT_ID||("u">typeof process?process.env.VITE_HEXCLAVE_PROJECT_ID:void 0)||b.env?.VITE_HEXCLAVE_PROJECT_ID||("u">typeof process?process.env.STACK_PROJECT_ID:void 0)||b.env?.STACK_PROJECT_ID||("u">typeof process?process.env.NEXT_PUBLIC_STACK_PROJECT_ID:void 0)||b.env?.NEXT_PUBLIC_STACK_PROJECT_ID||("u">typeof process?process.env.VITE_STACK_PROJECT_ID:void 0)||b.env?.VITE_STACK_PROJECT_ID||void 0},get HEXCLAVE_PUBLISHABLE_CLIENT_KEY(){return("u">typeof process?process.env.HEXCLAVE_PUBLISHABLE_CLIENT_KEY:void 0)||b.env?.HEXCLAVE_PUBLISHABLE_CLIENT_KEY||("u">typeof process?"":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_PUBLISHABLE_CLIENT_KEY||("u">typeof process?process.env.VITE_HEXCLAVE_PUBLISHABLE_CLIENT_KEY:void 0)||b.env?.VITE_HEXCLAVE_PUBLISHABLE_CLIENT_KEY||("u">typeof process?process.env.STACK_PUBLISHABLE_CLIENT_KEY:void 0)||b.env?.STACK_PUBLISHABLE_CLIENT_KEY||("u">typeof process?process.env.NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY:void 0)||b.env?.NEXT_PUBLIC_STACK_PUBLISHABLE_CLIENT_KEY||("u">typeof process?process.env.VITE_STACK_PUBLISHABLE_CLIENT_KEY:void 0)||b.env?.VITE_STACK_PUBLISHABLE_CLIENT_KEY||void 0},get HEXCLAVE_SECRET_SERVER_KEY(){return("u">typeof process?process.env.HEXCLAVE_SECRET_SERVER_KEY:void 0)||b.env?.HEXCLAVE_SECRET_SERVER_KEY||("u">typeof process?process.env.STACK_SECRET_SERVER_KEY:void 0)||b.env?.STACK_SECRET_SERVER_KEY||void 0},get HEXCLAVE_SUPER_SECRET_ADMIN_KEY(){return("u">typeof process?process.env.HEXCLAVE_SUPER_SECRET_ADMIN_KEY:void 0)||b.env?.HEXCLAVE_SUPER_SECRET_ADMIN_KEY||("u">typeof process?process.env.STACK_SUPER_SECRET_ADMIN_KEY:void 0)||b.env?.STACK_SUPER_SECRET_ADMIN_KEY||void 0},get HEXCLAVE_EXTRA_REQUEST_HEADERS(){return("u">typeof process?process.env.HEXCLAVE_EXTRA_REQUEST_HEADERS:void 0)||b.env?.HEXCLAVE_EXTRA_REQUEST_HEADERS||("u">typeof process?"":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_EXTRA_REQUEST_HEADERS||("u">typeof process?process.env.VITE_HEXCLAVE_EXTRA_REQUEST_HEADERS:void 0)||b.env?.VITE_HEXCLAVE_EXTRA_REQUEST_HEADERS||("u">typeof process?process.env.STACK_EXTRA_REQUEST_HEADERS:void 0)||b.env?.STACK_EXTRA_REQUEST_HEADERS||("u">typeof process?process.env.NEXT_PUBLIC_STACK_EXTRA_REQUEST_HEADERS:void 0)||b.env?.NEXT_PUBLIC_STACK_EXTRA_REQUEST_HEADERS||("u">typeof process?process.env.VITE_STACK_EXTRA_REQUEST_HEADERS:void 0)||b.env?.VITE_STACK_EXTRA_REQUEST_HEADERS||void 0},get HEXCLAVE_API_URL_BROWSER(){return("u">typeof process?process.env.HEXCLAVE_API_URL_BROWSER:void 0)||b.env?.HEXCLAVE_API_URL_BROWSER||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_API_URL_BROWSER:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_API_URL_BROWSER||("u">typeof process?process.env.VITE_HEXCLAVE_API_URL_BROWSER:void 0)||b.env?.VITE_HEXCLAVE_API_URL_BROWSER||("u">typeof process?process.env.STACK_API_URL_BROWSER:void 0)||b.env?.STACK_API_URL_BROWSER||("u">typeof process?process.env.NEXT_PUBLIC_STACK_API_URL_BROWSER:void 0)||b.env?.NEXT_PUBLIC_STACK_API_URL_BROWSER||("u">typeof process?process.env.VITE_STACK_API_URL_BROWSER:void 0)||b.env?.VITE_STACK_API_URL_BROWSER||("u">typeof process?process.env.BROWSER_STACK_API_URL:void 0)||b.env?.BROWSER_STACK_API_URL||("u">typeof process?process.env.NEXT_PUBLIC_BROWSER_STACK_API_URL:void 0)||b.env?.NEXT_PUBLIC_BROWSER_STACK_API_URL||("u">typeof process?process.env.VITE_BROWSER_STACK_API_URL:void 0)||b.env?.VITE_BROWSER_STACK_API_URL||("u">typeof process?process.env.BROWSER_HEXCLAVE_API_URL:void 0)||b.env?.BROWSER_HEXCLAVE_API_URL||("u">typeof process?process.env.NEXT_PUBLIC_BROWSER_HEXCLAVE_API_URL:void 0)||b.env?.NEXT_PUBLIC_BROWSER_HEXCLAVE_API_URL||("u">typeof process?process.env.VITE_BROWSER_HEXCLAVE_API_URL:void 0)||b.env?.VITE_BROWSER_HEXCLAVE_API_URL||void 0},get HEXCLAVE_API_URL_SERVER(){return("u">typeof process?process.env.HEXCLAVE_API_URL_SERVER:void 0)||b.env?.HEXCLAVE_API_URL_SERVER||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_API_URL_SERVER:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_API_URL_SERVER||("u">typeof process?process.env.VITE_HEXCLAVE_API_URL_SERVER:void 0)||b.env?.VITE_HEXCLAVE_API_URL_SERVER||("u">typeof process?process.env.STACK_API_URL_SERVER:void 0)||b.env?.STACK_API_URL_SERVER||("u">typeof process?process.env.NEXT_PUBLIC_STACK_API_URL_SERVER:void 0)||b.env?.NEXT_PUBLIC_STACK_API_URL_SERVER||("u">typeof process?process.env.VITE_STACK_API_URL_SERVER:void 0)||b.env?.VITE_STACK_API_URL_SERVER||("u">typeof process?process.env.SERVER_STACK_API_URL:void 0)||b.env?.SERVER_STACK_API_URL||("u">typeof process?process.env.NEXT_PUBLIC_SERVER_STACK_API_URL:void 0)||b.env?.NEXT_PUBLIC_SERVER_STACK_API_URL||("u">typeof process?process.env.VITE_SERVER_STACK_API_URL:void 0)||b.env?.VITE_SERVER_STACK_API_URL||("u">typeof process?process.env.SERVER_HEXCLAVE_API_URL:void 0)||b.env?.SERVER_HEXCLAVE_API_URL||("u">typeof process?process.env.NEXT_PUBLIC_SERVER_HEXCLAVE_API_URL:void 0)||b.env?.NEXT_PUBLIC_SERVER_HEXCLAVE_API_URL||("u">typeof process?process.env.VITE_SERVER_HEXCLAVE_API_URL:void 0)||b.env?.VITE_SERVER_HEXCLAVE_API_URL||void 0},get HEXCLAVE_API_URL(){return("u">typeof process?process.env.HEXCLAVE_API_URL:void 0)||b.env?.HEXCLAVE_API_URL||("u">typeof process?"":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_API_URL||("u">typeof process?process.env.VITE_HEXCLAVE_API_URL:void 0)||b.env?.VITE_HEXCLAVE_API_URL||("u">typeof process?process.env.STACK_API_URL:void 0)||b.env?.STACK_API_URL||("u">typeof process?process.env.NEXT_PUBLIC_STACK_API_URL:void 0)||b.env?.NEXT_PUBLIC_STACK_API_URL||("u">typeof process?process.env.VITE_STACK_API_URL:void 0)||b.env?.VITE_STACK_API_URL||("u">typeof process?process.env.HEXCLAVE_URL:void 0)||b.env?.HEXCLAVE_URL||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_URL:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_URL||("u">typeof process?process.env.VITE_HEXCLAVE_URL:void 0)||b.env?.VITE_HEXCLAVE_URL||("u">typeof process?process.env.STACK_URL:void 0)||b.env?.STACK_URL||("u">typeof process?process.env.NEXT_PUBLIC_STACK_URL:void 0)||b.env?.NEXT_PUBLIC_STACK_URL||("u">typeof process?process.env.VITE_STACK_URL:void 0)||b.env?.VITE_STACK_URL||void 0},get HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX(){return("u">typeof process?process.env.HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX:void 0)||b.env?.HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX||("u">typeof process?process.env.VITE_HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX:void 0)||b.env?.VITE_HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX||("u">typeof process?process.env.STACK_HOSTED_HANDLER_DOMAIN_SUFFIX:void 0)||b.env?.STACK_HOSTED_HANDLER_DOMAIN_SUFFIX||("u">typeof process?process.env.NEXT_PUBLIC_STACK_HOSTED_HANDLER_DOMAIN_SUFFIX:void 0)||b.env?.NEXT_PUBLIC_STACK_HOSTED_HANDLER_DOMAIN_SUFFIX||("u">typeof process?process.env.VITE_STACK_HOSTED_HANDLER_DOMAIN_SUFFIX:void 0)||b.env?.VITE_STACK_HOSTED_HANDLER_DOMAIN_SUFFIX||void 0},get HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE(){return("u">typeof process?process.env.HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE:void 0)||b.env?.HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE||("u">typeof process?process.env.VITE_HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE:void 0)||b.env?.VITE_HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE||("u">typeof process?process.env.STACK_HOSTED_HANDLER_URL_TEMPLATE:void 0)||b.env?.STACK_HOSTED_HANDLER_URL_TEMPLATE||("u">typeof process?process.env.NEXT_PUBLIC_STACK_HOSTED_HANDLER_URL_TEMPLATE:void 0)||b.env?.NEXT_PUBLIC_STACK_HOSTED_HANDLER_URL_TEMPLATE||("u">typeof process?process.env.VITE_STACK_HOSTED_HANDLER_URL_TEMPLATE:void 0)||b.env?.VITE_STACK_HOSTED_HANDLER_URL_TEMPLATE||void 0},get HEXCLAVE_STRIPE_PUBLISHABLE_KEY(){return("u">typeof process?process.env.HEXCLAVE_STRIPE_PUBLISHABLE_KEY:void 0)||b.env?.HEXCLAVE_STRIPE_PUBLISHABLE_KEY||("u">typeof process?"":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_STRIPE_PUBLISHABLE_KEY||("u">typeof process?process.env.VITE_HEXCLAVE_STRIPE_PUBLISHABLE_KEY:void 0)||b.env?.VITE_HEXCLAVE_STRIPE_PUBLISHABLE_KEY||("u">typeof process?process.env.STACK_STRIPE_PUBLISHABLE_KEY:void 0)||b.env?.STACK_STRIPE_PUBLISHABLE_KEY||("u">typeof process?process.env.NEXT_PUBLIC_STACK_STRIPE_PUBLISHABLE_KEY:void 0)||b.env?.NEXT_PUBLIC_STACK_STRIPE_PUBLISHABLE_KEY||("u">typeof process?process.env.VITE_STACK_STRIPE_PUBLISHABLE_KEY:void 0)||b.env?.VITE_STACK_STRIPE_PUBLISHABLE_KEY||void 0},get HEXCLAVE_BOT_CHALLENGE_SITE_KEY(){return("u">typeof process?process.env.HEXCLAVE_BOT_CHALLENGE_SITE_KEY:void 0)||b.env?.HEXCLAVE_BOT_CHALLENGE_SITE_KEY||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_BOT_CHALLENGE_SITE_KEY:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_BOT_CHALLENGE_SITE_KEY||("u">typeof process?process.env.VITE_HEXCLAVE_BOT_CHALLENGE_SITE_KEY:void 0)||b.env?.VITE_HEXCLAVE_BOT_CHALLENGE_SITE_KEY||("u">typeof process?process.env.STACK_BOT_CHALLENGE_SITE_KEY:void 0)||b.env?.STACK_BOT_CHALLENGE_SITE_KEY||("u">typeof process?process.env.NEXT_PUBLIC_STACK_BOT_CHALLENGE_SITE_KEY:void 0)||b.env?.NEXT_PUBLIC_STACK_BOT_CHALLENGE_SITE_KEY||("u">typeof process?process.env.VITE_STACK_BOT_CHALLENGE_SITE_KEY:void 0)||b.env?.VITE_STACK_BOT_CHALLENGE_SITE_KEY||void 0},get HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY(){return("u">typeof process?process.env.HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY:void 0)||b.env?.HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY||("u">typeof process?process.env.VITE_HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY:void 0)||b.env?.VITE_HEXCLAVE_BOT_CHALLENGE_INVISIBLE_SITE_KEY||("u">typeof process?process.env.STACK_BOT_CHALLENGE_INVISIBLE_SITE_KEY:void 0)||b.env?.STACK_BOT_CHALLENGE_INVISIBLE_SITE_KEY||("u">typeof process?process.env.NEXT_PUBLIC_STACK_BOT_CHALLENGE_INVISIBLE_SITE_KEY:void 0)||b.env?.NEXT_PUBLIC_STACK_BOT_CHALLENGE_INVISIBLE_SITE_KEY||("u">typeof process?process.env.VITE_STACK_BOT_CHALLENGE_INVISIBLE_SITE_KEY:void 0)||b.env?.VITE_STACK_BOT_CHALLENGE_INVISIBLE_SITE_KEY||void 0},get HEXCLAVE_IS_LOCAL_EMULATOR(){return("u">typeof process?process.env.HEXCLAVE_IS_LOCAL_EMULATOR:void 0)||b.env?.HEXCLAVE_IS_LOCAL_EMULATOR||("u">typeof process?"":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_IS_LOCAL_EMULATOR||("u">typeof process?process.env.VITE_HEXCLAVE_IS_LOCAL_EMULATOR:void 0)||b.env?.VITE_HEXCLAVE_IS_LOCAL_EMULATOR||("u">typeof process?process.env.STACK_IS_LOCAL_EMULATOR:void 0)||b.env?.STACK_IS_LOCAL_EMULATOR||("u">typeof process?process.env.NEXT_PUBLIC_STACK_IS_LOCAL_EMULATOR:void 0)||b.env?.NEXT_PUBLIC_STACK_IS_LOCAL_EMULATOR||("u">typeof process?process.env.VITE_STACK_IS_LOCAL_EMULATOR:void 0)||b.env?.VITE_STACK_IS_LOCAL_EMULATOR||void 0},get HEXCLAVE_POSTHOG_KEY(){return("u">typeof process?process.env.HEXCLAVE_POSTHOG_KEY:void 0)||b.env?.HEXCLAVE_POSTHOG_KEY||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_POSTHOG_KEY:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_POSTHOG_KEY||("u">typeof process?process.env.VITE_HEXCLAVE_POSTHOG_KEY:void 0)||b.env?.VITE_HEXCLAVE_POSTHOG_KEY||("u">typeof process?process.env.STACK_POSTHOG_KEY:void 0)||b.env?.STACK_POSTHOG_KEY||("u">typeof process?process.env.NEXT_PUBLIC_STACK_POSTHOG_KEY:void 0)||b.env?.NEXT_PUBLIC_STACK_POSTHOG_KEY||("u">typeof process?process.env.VITE_STACK_POSTHOG_KEY:void 0)||b.env?.VITE_STACK_POSTHOG_KEY||void 0},get HEXCLAVE_SVIX_SERVER_URL(){return("u">typeof process?process.env.HEXCLAVE_SVIX_SERVER_URL:void 0)||b.env?.HEXCLAVE_SVIX_SERVER_URL||("u">typeof process?"":void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_SVIX_SERVER_URL||("u">typeof process?process.env.VITE_HEXCLAVE_SVIX_SERVER_URL:void 0)||b.env?.VITE_HEXCLAVE_SVIX_SERVER_URL||("u">typeof process?process.env.STACK_SVIX_SERVER_URL:void 0)||b.env?.STACK_SVIX_SERVER_URL||("u">typeof process?process.env.NEXT_PUBLIC_STACK_SVIX_SERVER_URL:void 0)||b.env?.NEXT_PUBLIC_STACK_SVIX_SERVER_URL||("u">typeof process?process.env.VITE_STACK_SVIX_SERVER_URL:void 0)||b.env?.VITE_STACK_SVIX_SERVER_URL||void 0},get HEXCLAVE_SENTRY_DSN(){return("u">typeof process?process.env.HEXCLAVE_SENTRY_DSN:void 0)||b.env?.HEXCLAVE_SENTRY_DSN||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_SENTRY_DSN:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_SENTRY_DSN||("u">typeof process?process.env.VITE_HEXCLAVE_SENTRY_DSN:void 0)||b.env?.VITE_HEXCLAVE_SENTRY_DSN||("u">typeof process?process.env.STACK_SENTRY_DSN:void 0)||b.env?.STACK_SENTRY_DSN||("u">typeof process?process.env.NEXT_PUBLIC_STACK_SENTRY_DSN:void 0)||b.env?.NEXT_PUBLIC_STACK_SENTRY_DSN||("u">typeof process?process.env.VITE_STACK_SENTRY_DSN:void 0)||b.env?.VITE_STACK_SENTRY_DSN||void 0},get HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY(){return("u">typeof process?process.env.HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY:void 0)||b.env?.HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY||("u">typeof process?process.env.NEXT_PUBLIC_HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY:void 0)||b.env?.NEXT_PUBLIC_HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY||("u">typeof process?process.env.VITE_HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY:void 0)||b.env?.VITE_HEXCLAVE_VERSION_ALERTER_SEVERE_ONLY||("u">typeof process?process.env.STACK_VERSION_ALERTER_SEVERE_ONLY:void 0)||b.env?.STACK_VERSION_ALERTER_SEVERE_ONLY||("u">typeof process?process.env.NEXT_PUBLIC_STACK_VERSION_ALERTER_SEVERE_ONLY:void 0)||b.env?.NEXT_PUBLIC_STACK_VERSION_ALERTER_SEVERE_ONLY||("u">typeof process?process.env.VITE_STACK_VERSION_ALERTER_SEVERE_ONLY:void 0)||b.env?.VITE_STACK_VERSION_ALERTER_SEVERE_ONLY||void 0},get NODE_ENV(){return("u">typeof process?"production":void 0)||b.env?.NODE_ENV||void 0}}])},1919,a=>{"use strict";a.s(["HEXCLAVE_LOGO_SVG",0,'<svg width="16" height="16" viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="miter"><path d="M 24 4 L 41.32 14 L 41.32 34 L 24 44 L 6.68 34 L 6.68 14 Z"/><path d="M 11 16.87 L 14 15.13 L 14 32.87 L 11 31.13 Z" fill="currentColor" stroke="none"/><path d="M 11 16.87 L 14 15.13 L 14 32.87 L 11 31.13 Z" fill="currentColor" stroke="none" transform="rotate(120 24 24)"/><path d="M 11 16.87 L 14 15.13 L 14 32.87 L 11 31.13 Z" fill="currentColor" stroke="none" transform="rotate(240 24 24)"/></svg>'])},421910,a=>{"use strict";var b=a.i(849092),c=a.i(270314),d=a.i(938152),e=a.i(415172),f=a.i(618228),g=a.i(489872),h=a.i(18726),i=a.i(446521),j=a.i(836382),k=a.i(458311),l=a.i(56136),m=a.i(648812),n=a.i(307469),o=a.i(957250),p=a.i(799052),q=a.i(538107);function r(a){let b;var c=(b=a?"string"==typeof a?a:(0,k.isBrowserLike)()?a.browser:a.server:(b=(0,k.isBrowserLike)()?o.envVars.HEXCLAVE_API_URL_BROWSER:o.envVars.HEXCLAVE_API_URL_SERVER)||o.envVars.HEXCLAVE_API_URL||"https://api.hexclave.com").endsWith("/")?b.slice(0,-1):b;if(!c)return c;let d=o.envVars.HEXCLAVE_PORT_PREFIX;return d?c.replace(/\$\{NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX:-81\}/g,d):c}let s="https://api.hexclave.com",t=new Map([[s,"https://r.hexclave.com"],["https://api.stack-auth.com","https://r.stack-auth.com"]]),u=new Map;a.s(["clientVersion",0,"js @hexclave/next@1.0.96","createCache",0,a=>new i.AsyncCache(async b=>await j.Result.fromThrowingAsync(async()=>await a(b)),{}),"createCacheBySession",0,a=>new i.AsyncCache(async([b,...c])=>await j.Result.fromThrowingAsync(async()=>await a(b,c)),{onSubscribe:([a],b)=>{let c=a.onInvalidate(()=>b());return()=>c.unsubscribe()}}),"createEmptyTokenStore",0,function(){return new n.Store({refreshToken:null,accessToken:null})},"defaultBaseUrl",0,s,"getAnalyticsBaseUrl",0,function(a){return t.get(a)??a},"getBaseUrl",0,r,"getDefaultExtraRequestHeaders",0,function(){return JSON.parse(o.envVars.HEXCLAVE_EXTRA_REQUEST_HEADERS||"{}")},"getDefaultProjectId",0,function(){let a;return o.envVars.HEXCLAVE_PROJECT_ID||((a=>{if(!(0,k.isBrowserLike)())return;let b=globalThis,c="__hexclave_missing_config_alert_already_shown";if(b[c])return;b[c]=!0;let d=b.alert;"function"==typeof d&&d(a)})(a=c.deindent`
    Welcome to Hexclave!
    
    It seems that you haven't provided a project ID.

    ${o.envVars.NODE_ENV?.includes("dev")?c.deindent`
    ...
    `:o.envVars.NODE_ENV?.includes("prod")?c.deindent`
    ...
    `}
  `),(0,d.throwErr)(Error(a)))},"getDefaultPublishableClientKey",0,function(){return o.envVars.HEXCLAVE_PUBLISHABLE_CLIENT_KEY},"getDefaultSecretServerKey",0,function(){return o.envVars.HEXCLAVE_SECRET_SERVER_KEY||(0,d.throwErr)(Error("No secret server key provided. Please copy your key from the Hexclave dashboard and put it in the HEXCLAVE_SECRET_SERVER_KEY environment variable."))},"getDefaultSuperSecretAdminKey",0,function(){return o.envVars.HEXCLAVE_SUPER_SECRET_ADMIN_KEY||(0,d.throwErr)(Error("No super secret admin key provided. Please copy your key from the Hexclave dashboard and put it in the HEXCLAVE_SUPER_SECRET_ADMIN_KEY environment variable."))},"getUrls",0,function(a,b){return(0,q.resolveHandlerUrls)({urls:a,projectId:b.projectId})},"resolveApiUrls",0,function(a){return()=>{if(null!=a)return[r(a)];let c=r(void 0);return(0,l.createGlobal)("__stack-fetch-backend-urls-started",()=>((0,b.runAsynchronously)(async()=>{try{let a=await fetch(`${c}/api/v1/internal/backend-urls`);if(!a.ok)return;let b=await a.json();if(!Array.isArray(b.urls)||!b.urls.every(a=>"string"==typeof a))return;(0,l.createGlobal)("__stack-fetched-backend-urls",()=>b.urls)}catch(a){(0,d.captureError)("fetch-backend-urls-in-background",a)}}),!0)),(0,l.getGlobal)("__stack-fetched-backend-urls")??(0,h.getDefaultApiUrls)(c)}},"resolveConstructorOptions",0,function(a){return{...a.inheritsFrom?.[m.hexclaveAppInternalsSymbol].getConstructorOptions()??{},...(0,g.filterUndefined)((0,g.omit)(a,["inheritsFrom"]))}},"useAsyncCache",0,function(a,b,c){for(let d of((0,p.suspendIfSsr)(c),(0,l.getGlobal)("use-async-cache-execution-hooks")??[]))d({cache:a,caller:c,dependencies:b});let g=e.default.useId();e.default.useEffect(()=>{u.delete(g)},[...b,g]);let h=(0,e.useCallback)(c=>{let{unsubscribe:d}=a.onStateChange(b,()=>{u.delete(g),c()});return d},[a,...b]),i=(0,e.useCallback)(()=>(u.has(g)||u.set(g,a.getOrWait(b,"read-write")),u.get(g)),[a,...b]),j=(0,f.use)(e.default.useSyncExternalStore(h,i,i));if("error"===j.status){let a=j.error;throw a instanceof Error&&!a.__stackHasConcatenatedStacktraces&&((0,d.concatStacktraces)(a,Error()),a.__stackHasConcatenatedStacktraces=!0),a}return j.data}])},538107,a=>{"use strict";var b=a.i(938152);a.i(890714);var c=a.i(823326),d=a.i(245800),e=a.i(957250);let f=/^[a-zA-Z][a-zA-Z\d+\-.]*:/,g=(0,c.getCustomPagePrompts)(),h=(a,b)=>{let c=a.endsWith("/")&&a.length>1?a.slice(0,-1):a;return 0===b.length?c:"/"===c?`/${b}`:`${c}/${b}`},i=a=>{let b=a.handlerName;if(b in g){let c=g[b];if(0===a.target.version||a.target.version in c.versions)return a.target.url;throw Error(`Unsupported custom page version ${a.target.version} for ${a.handlerName} page at ${a.target.url}. The latest supported version of this page is ${Math.max(0,...Object.keys(c.versions).map(Number))}. Please upgrade your Hexclave SDK to a version that supports this version.`)}throw Error(`URL target ${a.handlerName} cannot be a custom page. Please specify the URL as a string instead.`)},j=a=>{let b=a.pagePath.replace(/^\/+/,""),c=b.length>0?`handler/${b}`:"handler";return(0,d.getHostedHandlerUrlFromConfig)({projectId:a.projectId,hostedPath:c,hostedHandlerDomainSuffix:e.envVars.HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX,hostedHandlerUrlTemplate:e.envVars.HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE,hexclavePortPrefix:e.envVars.HEXCLAVE_PORT_PREFIX})},k=new Set(["home","afterSignIn","afterSignUp","afterSignOut"]),l=a=>{if("string"==typeof a.target)return a.target;switch(a.target.type){case"handler-component":return a.fallbackPath;case"hosted":if(k.has(a.handlerName))return a.fallbackPath;return j({projectId:a.projectId,pagePath:(a=>{switch(a){case"handler":case"home":case"afterSignIn":case"afterSignUp":case"afterSignOut":return"";case"signIn":return"sign-in";case"signUp":return"sign-up";case"signOut":return"sign-out";case"emailVerification":return"email-verification";case"passwordReset":return"password-reset";case"forgotPassword":return"forgot-password";case"oauthCallback":return"oauth-callback";case"magicLinkCallback":return"magic-link-callback";case"accountSettings":return"account-settings";case"teamInvitation":return"team-invitation";case"cliAuthConfirm":return"cli-auth-confirm";case"mfa":return"mfa";case"error":return"error";case"onboarding":return"onboarding"}})(a.handlerName)});case"custom":return i({target:a.target,handlerName:a.handlerName})}};a.s(["buildCliAuthConfirmUrl",0,a=>{let b=new URL(a.cliAuthConfirmUrl,a.appUrl);return b.searchParams.set("login_code",a.loginCode),b.toString()},"getHostedHandlerUrl",0,j,"getPagePrompt",0,function(a,b){if(!(a in g))return null;let c=g[a],d=Object.keys(c.versions).map(Number),e=d.length>0?Math.max(...d):0,f=null;if(null!=b){let a=d.filter(a=>a>b).sort((a,b)=>a-b).map(a=>c.versions[a].upgradePrompt).filter(a=>a.length>0);f=a.length>0?a.join("\n\n"):null}else f=(e>0?c.versions[e]:void 0)?.upgradePrompt??null;return{title:c.title,fullPrompt:c.fullPrompt,upgradePrompt:f,latestVersion:e}},"isHostedHandlerUrlForProject",0,a=>{let b;try{b=new URL(a.url)}catch{return!1}let c=new URL(j({projectId:a.projectId,pagePath:""}));return b.origin===c.origin&&(b.pathname===c.pathname||b.pathname.startsWith(`${c.pathname}/`))},"resolveHandlerUrls",0,a=>{let c=a.urls,d=c?.default??{type:"handler-component"},e=c?.oauthCallback??("hosted"===d.type?d:{type:"handler-component"}),g="string"==typeof e?e:"custom"===e.type?e.url:null;if(null!=g&&!(!g.startsWith("//")&&!f.test(g)))throw new b.HexclaveAssertionError("OAuth callback URLs must be relative.",{oauthCallbackUrl:g,hint:"Use a relative URL like '/handler/oauth-callback', or use { type: 'hosted' } to let Stack use the current page for hosted callbacks."});let j="/handler";"string"==typeof c?.handler?j=c.handler:c?.handler!=null&&"custom"===c.handler.type&&(j=i({target:c.handler,handlerName:"handler"}));let k=c?.home??d,m=l({target:"string"!=typeof k&&"hosted"===k.type?{type:"handler-component"}:k,fallbackPath:"/",handlerName:"home",projectId:a.projectId}),n=l({target:k,fallbackPath:"/",handlerName:"home",projectId:a.projectId}),o=l({target:c?.afterSignIn??d,fallbackPath:m,handlerName:"afterSignIn",projectId:a.projectId});return{handler:l({target:c?.handler??d,fallbackPath:j,handlerName:"handler",projectId:a.projectId}),signIn:l({target:c?.signIn??d,fallbackPath:h(j,"sign-in"),handlerName:"signIn",projectId:a.projectId}),signUp:l({target:c?.signUp??d,fallbackPath:h(j,"sign-up"),handlerName:"signUp",projectId:a.projectId}),afterSignIn:o,afterSignUp:l({target:c?.afterSignUp??d,fallbackPath:o,handlerName:"afterSignUp",projectId:a.projectId}),signOut:l({target:c?.signOut??d,fallbackPath:h(j,"sign-out"),handlerName:"signOut",projectId:a.projectId}),afterSignOut:l({target:c?.afterSignOut??d,fallbackPath:m,handlerName:"afterSignOut",projectId:a.projectId}),emailVerification:l({target:c?.emailVerification??d,fallbackPath:h(j,"email-verification"),handlerName:"emailVerification",projectId:a.projectId}),passwordReset:l({target:c?.passwordReset??d,fallbackPath:h(j,"password-reset"),handlerName:"passwordReset",projectId:a.projectId}),forgotPassword:l({target:c?.forgotPassword??d,fallbackPath:h(j,"forgot-password"),handlerName:"forgotPassword",projectId:a.projectId}),home:n,oauthCallback:l({target:e,fallbackPath:h(j,"oauth-callback"),handlerName:"oauthCallback",projectId:a.projectId}),magicLinkCallback:l({target:c?.magicLinkCallback??d,fallbackPath:h(j,"magic-link-callback"),handlerName:"magicLinkCallback",projectId:a.projectId}),accountSettings:l({target:c?.accountSettings??d,fallbackPath:h(j,"account-settings"),handlerName:"accountSettings",projectId:a.projectId}),teamInvitation:l({target:c?.teamInvitation??d,fallbackPath:h(j,"team-invitation"),handlerName:"teamInvitation",projectId:a.projectId}),cliAuthConfirm:l({target:c?.cliAuthConfirm??d,fallbackPath:h(j,"cli-auth-confirm"),handlerName:"cliAuthConfirm",projectId:a.projectId}),mfa:l({target:c?.mfa??d,fallbackPath:h(j,"mfa"),handlerName:"mfa",projectId:a.projectId}),error:l({target:c?.error??d,fallbackPath:h(j,"error"),handlerName:"error",projectId:a.projectId}),onboarding:l({target:c?.onboarding??d,fallbackPath:h(j,"onboarding"),handlerName:"onboarding",projectId:a.projectId})}}])},990038,(a,b,c)=>{let{createClientModuleProxy:d}=a.r(51145);a.n(d("[project]/packages/next/dist/esm/utils/react.js"))},799052,a=>{"use strict";var b=a.i(990038);a.n(b)},890714,823326,245800,a=>{"use strict";var b=a.i(270314),c=a.i(494537);let d=b.deindent`
...
`;function e(a){let c=Math.max(1,...Object.keys(a.versions).map(Number)),e=1===c?a.minSdkVersion:a.versions[c].minSdkVersion,f=b.deindent`
    This prompt explains how to implement a custom ${a.title} page for Hexclave. The version of this page that you are implementing is v${c}. It can be found in Hexclave's documentation, and in the Hexclave devtool indicator.

    First, make sure to upgrade the Hexclave SDK to a recent version. The minimum supported SDK version for this walkthrough is v${e}.

    The user's codebase may already have a ${a.title} page that could be suitable (eg. from an earlier version of Hexclave, a template, another auth provider before migrating to Hexclave, etc.). Use your critical thinking skills to determine what the user's intent is; it is likely that instead of creating a new page, you can just modify the existing page to use Hexclave & support the logic/structure below.
    ...
    \`\`\`tsx
      urls: {
        ${JSON.stringify(a.key)}: { type: "custom", url: "/path/to/your/custom/page", version: ${c} },
        // ...
      },
    \`\`\`

    ${d}
  `,g={1:{minSdkVersion:a.minSdkVersion,upgradePrompt:f,changelog:"Initial version."},...a.versions};return{title:a.title,versions:g,fullPrompt:f}}function f(a){let c="signIn"===a,d=c?"sign in":"sign up",f=c?"hexclaveApp.signInWithCredential({ email: form.email, password: form.password })":"hexclaveApp.signUpWithCredential({ email: form.email, password: form.password })";return e({key:a,title:c?"Sign In":"Sign Up",minSdkVersion:"0.0.1",structure:b.deindent`
      - If user is already signed in, regardless of whether restricted or not (ie. \`await hexclaveApp.getUser({ includeRestricted: true }) !== null\`):
        ...
        - Otherwise, \`await hexclaveApp.redirectToAfterSign${c?"In":"Up"}({ replace: true })\`
      ...
      - If user is not signed in:
        ${c?"- If sign-ups are enabled (\\`project = await hexclaveApp.getProject(); project.config.signUpEnabled\\`), show a link to the sign-up page.":"- If sign-ups are disabled (\\`project = await hexclaveApp.getProject(); !project.config.signUpEnabled\\`), show a message that sign-up is disabled."}
        - Show a ${d} screen. The auth methods that should render:
          ...
          ${c?"- If \\`project.config.passkeyEnabled\\`, render a passkey button. Clicking the button calls \\`await hexclaveApp.signInWithPasskey()\\`.":""}
          - If \`project.config.credentialEnabled\`, render a credential ${d} form:
            - Email + password${c?"":" + repeat password"}
            ${c?"":"- Validate password strength with \\`getPasswordError()\\` and ensure repeated password matches"}
            ${c?'- "Forgot password?" link calling \\`await hexclaveApp.redirectToForgotPassword()\\`':""}
            - Submit calls \`${f}: ${c?'Promise<Result<undefined, KnownErrors["EmailPasswordMismatch"] | KnownErrors["InvalidTotpCode"]>>':'Promise<Result<undefined, KnownErrors["UserWithEmailAlreadyExists"] | KnownErrors["ContactChannelAlreadyUsedForAuthBySomeoneElse"] | KnownErrors["PasswordRequirementsNotMet"] | KnownErrors["BotChallengeFailed"]>>'}\`
        ...
        - Show a link to the ${c?"sign up":"sign in"} page that calls \`await hexclaveApp.redirectTo${c?"SignUp":"SignIn"}()\`.
    `,reactExample:b.deindent`
      export default function Custom${c?"SignIn":"SignUp"}Page() {
        ...
        useEffect(() => {
          if (user) {
            if (user.isRestricted) {
              ...
              void hexclaveApp.redirectToAfterSign${c?"In":"Up"}();
            }
          }
        }, [user]);
        ...
        ${c?"const hasPasskey = project.config.passkeyEnabled;":""}
        const hasCredential = project.config.credentialEnabled;
        const hasMagicLink = project.config.magicLinkEnabled;
        const showSeparator = (hasCredential || hasMagicLink) && ${c?"(hasOAuthProviders || hasPasskey)":"hasOAuthProviders"};
        const hasAnyAuthMethod = hasOAuthProviders || hasCredential || hasMagicLink${c?" || hasPasskey":""};

        return (
          <div>
            <Typography type="h2">${c?"Sign in to your account":"Create a new account"}</Typography>
            ${c?`{
            ...
            {${c?"(hasOAuthProviders || hasPasskey)":"hasOAuthProviders"} && (
              <div>
                {project.config.oauthProviders.map((provider) => (
                  ...
                  >
                    ${c?"Sign in":"Sign up"} with {provider.id}
                  </Button>
                ))}
                ${c?`{hasPasskey && (
            ...
            {hasCredential || hasMagicLink ? (
              <Tabs>
                ...
                {hasCredential && <TabsContent value="password">
                  <Form onSubmit={async (form) => {
                    ${c?"":`if (form.password !== form.passwordRepeat) {
                      handleErrorNicely(...);
                      return;
                    }`}
                    ...
                    ${c?`<Button type="button" variant="link" onClick={async () => await hexclaveApp.redirectToForgotPassword()}>
                      Forgot password?
    ...
    `,notes:b.deindent`
      - This page shares a lot of code with the ${c?"signUp":"signIn"} page, and potentially other pages. Make sure to reuse code and keep behavior consistent wherever possible.
    `,versions:{}})}function g(){return{signIn:f("signIn"),signUp:f("signUp"),signOut:e({key:"signOut",title:"Sign Out",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),emailVerification:e({key:"emailVerification",title:"Email Verification",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),passwordReset:e({key:"passwordReset",title:"Password Reset",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),forgotPassword:e({key:"forgotPassword",title:"Forgot Password",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),oauthCallback:e({key:"oauthCallback",title:"OAuth Callback",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),magicLinkCallback:e({key:"magicLinkCallback",title:"Magic Link Callback",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),accountSettings:e({key:"accountSettings",title:"Account Settings",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),teamInvitation:e({key:"teamInvitation",title:"Team Invitation",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),cliAuthConfirm:e({key:"cliAuthConfirm",title:"CLI Auth Confirmation",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),mfa:e({key:"mfa",title:"MFA",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),error:e({key:"error",title:"Error",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}}),onboarding:e({key:"onboarding",title:"Onboarding",minSdkVersion:"0.0.1",structure:b.deindent`
      ...
      `,versions:{}})}}a.s(["getCustomPagePrompts",0,g,"getLatestPageVersions",0,function(){return Object.fromEntries(Object.entries(g()).map(([a,b])=>{let c=Object.keys(b.versions).map(Number),d=c.length>0?Math.max(...c):0,e={};for(let a of c)b.versions[a].changelog&&(e[a]=b.versions[a].changelog);return[a,{version:d,changelogs:e}]}))}],823326),a.s([],890714);var h=a.i(938152),i=a.i(18726);let j="{projectId}",k="{hostedPath}",l=new Map([["https:","443"],["http:","80"]]),m="00000000-0000-4000-8000-000000000000";function n(a,b){if(null!=a)return b?a.replace(/\$\{NEXT_PUBLIC_HEXCLAVE_PORT_PREFIX:-81\}/g,b):a}function o(a,b,c){return a.replaceAll(j,b).replaceAll(k,c)}function p(a){let b=a.port||l.get(a.protocol)||"";return b?`${a.hostname}:${b}`:a.hostname}function q(a){let b=a.indexOf("://");if(-1===b)return null;let c=`${a.slice(0,b)}:`,d=a.slice(b+3),e=d.indexOf("/"),f=-1===e?d:d.slice(0,e);return""===f?null:{protocol:c,hostPattern:f}}function r(a){let b=a.lastIndexOf(":");if(-1===b)return!1;let c=a.slice(b+1);return"*"===c||""!==c&&[...c].every(a=>a>="0"&&a<="9")}a.s(["getHostedHandlerUrlFromConfig",0,function(a){let b=n(a.hostedHandlerUrlTemplate,a.hexclavePortPrefix);return null==b?(()=>{let b=n(a.hostedHandlerDomainSuffix,a.hexclavePortPrefix)??".built-with-hexclave.com";if(!b.startsWith("."))throw new h.HexclaveAssertionError("The hosted handler domain suffix must start with a dot.",{domainSuffix:b,hint:"Set NEXT_PUBLIC_HEXCLAVE_HOSTED_HANDLER_DOMAIN_SUFFIX to a value like '.built-with-hexclave.com'."});return`https://${a.projectId}${b}/${a.hostedPath}`})():(()=>{if(!b.includes(j)||!b.includes(k))throw new h.HexclaveAssertionError("The hosted handler URL template must contain {projectId} and {hostedPath}.",{hostedHandlerUrlTemplate:b,hint:"Set NEXT_PUBLIC_HEXCLAVE_HOSTED_HANDLER_URL_TEMPLATE to a value like 'https://{projectId}.built-with-hexclave.com/{hostedPath}'."});let c=new URL(o(b,m,"handler")),d=new URL(o(b,"11111111-1111-4111-8111-111111111111","handler"));if(c.origin===d.origin||!c.hostname.includes(m))throw new h.HexclaveAssertionError("The hosted handler URL template must put {projectId} in the hostname.",{hostedHandlerUrlTemplate:b,hint:"Use a project-specific origin like 'https://{projectId}.built-with-hexclave.com/{hostedPath}', not a shared-origin path like 'https://example.com/{projectId}/{hostedPath}'."});return o(b,a.projectId,a.hostedPath)})()},"getTrustedParentDomain",0,function(a,b){let c=b.filter(a=>null!=a).map(a=>{let b=(0,i.createUrlIfValid)(a);if(null!=b&&!a.includes("*"))return b.hostname.toLowerCase();let c=q(a);return null==c?null:(function(a){if(!r(a))return a;let b=a.lastIndexOf(":");return a.slice(0,b)})(c.hostPattern).toLowerCase()}).filter(a=>null!=a),d=a.toLowerCase().split(".");for(let a=d.length-2;a>=0;a--){let b=d.slice(a).join(".");if(c.includes(b)&&c.includes(`**.${b}`))return b}return null},"validateRedirectUrl",0,function(a,b){let c=(0,i.createUrlIfValid)(a);return!!c&&(!!(!0===b.allowLocalhost&&(0,i.isLocalhost)(c))||b.trustedDomains.some(a=>null!=a&&function(a,b){let c=(0,i.createUrlIfValid)(b);if(null!=c&&!b.includes("*"))return c.protocol===a.protocol&&c.hostname===a.hostname&&p(c)===p(a);let d=q(b);return null==d?((0,h.captureError)("invalid-redirect-domain",new h.HexclaveAssertionError("Invalid domain pattern",{pattern:b})),!1):a.protocol===d.protocol&&(r(d.hostPattern)?(0,i.matchHostnamePattern)(d.hostPattern,p(a)):(0,i.matchHostnamePattern)(d.hostPattern,a.hostname)&&(!a.port||"https:"===a.protocol&&"443"===a.port||"http:"===a.protocol&&"80"===a.port))}(c,a)))}],245800)},446521,a=>{"use strict";var b=a.i(458311),c=a.i(481717),d=a.i(489872),e=a.i(849092),f=a.i(307469),g=class{constructor(a,b={}){this._fetcher=a,this._options=b,this._map=new c.DependenciesMap,this.isCacheAvailable=this._createKeyed("isCacheAvailable"),this.getIfCached=this._createKeyed("getIfCached"),this.getOrWait=this._createKeyed("getOrWait"),this.forceSetCachedValue=this._createKeyed("forceSetCachedValue"),this.forceSetCachedValueAsync=this._createKeyed("forceSetCachedValueAsync"),this.refresh=this._createKeyed("refresh"),this.invalidate=this._createKeyed("invalidate"),this.onStateChange=this._createKeyed("onStateChange"),this.isDirty=this._createKeyed("isDirty")}_createKeyed(a){return(b,...c)=>{let d=this.getValueCache(b);return d[a].apply(d,c)}}getValueCache(a){let b=this._map.get(a);return b||(b=new h(async()=>await this._fetcher(a),{...this._options,onSubscribe:this._options.onSubscribe?b=>this._options.onSubscribe(a,b):void 0}),this._map.set(a,b)),b}async refreshWhere(a){let b=[];for(let[c,d]of this._map)a(c)&&b.push(d.refresh());await Promise.all(b)}async invalidateWhere(a){let b=[];for(let[c,d]of this._map)a(c)&&b.push(d.invalidate().catch(()=>void 0));await Promise.all(b)}},h=class{constructor(a,b={}){this._options=b,this._subscriptionsCount=0,this._unsubscribers=[],this._mostRecentRefreshPromiseIndex=0,this._store=new f.AsyncStore,this._rateLimitOptions={concurrency:1,throttleMs:300,...(0,d.filterUndefined)(b.rateLimiter??{})},this._fetcher=(0,e.rateLimited)(a,{...this._rateLimitOptions,batchCalls:!0})}isCacheAvailable(){return this._store.isAvailable()}getIfCached(){return this._store.get()}getOrWait(a){let b=this.getIfCached();return"read-write"===a&&"ok"===b.status?(0,e.resolved)(b.data):this._refetch(a)}_set(a){this._store.set(a)}_setAsync(a){0!==this._subscriptionsCount||(0,b.isBrowserLike)()||this._invalidateCacheSoon();let c=(0,e.pending)(a);return this._pendingPromise=c,(0,e.pending)(this._store.setAsync(c).then(()=>void 0))}_refetch(a){if("read-write"===a&&this._pendingPromise)return this._pendingPromise;let b=(0,e.pending)(this._fetcher());return"never"===a?b:(0,e.pending)(this._setAsync(b).then(()=>b))}forceSetCachedValue(a){this._set(a)}forceSetCachedValueAsync(a){return this._setAsync(a)}async refresh(){this._subscriptionsCount>0&&await this.getOrWait("write-only")}async invalidate(){this._store.setUnavailable(),this._pendingPromise=void 0,await this.refresh()}isDirty(){return void 0===this._pendingPromise}_invalidateCacheSoon(){let a=++this._mostRecentRefreshPromiseIndex;(0,e.runAsynchronously)(async()=>{await (0,e.wait)(5e3),0===this._subscriptionsCount&&a===this._mostRecentRefreshPromiseIndex&&await this.invalidate()})}onStateChange(a){let b=this._store.onChange(a);if((0,e.runAsynchronously)(this.getOrWait("read-write")),0==this._subscriptionsCount++&&this._options.onSubscribe){let a=this._options.onSubscribe(()=>{(0,e.runAsynchronously)(this.refresh())});this._unsubscribers.push(a)}let c=!1;return{unsubscribe:()=>{if(!c&&(c=!0,b.unsubscribe(),0==--this._subscriptionsCount))for(let a of(this._invalidateCacheSoon(),this._unsubscribers))a()}}}};a.s(["AsyncCache",0,g])}];

//# sourceMappingURL=packages_0v4l9ly._.js.map